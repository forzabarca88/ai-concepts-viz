...
- User can select different UI elements to navigate to different sections or pages within the website - each section should interactively visualise different concepts related to LLMs such as:
    ...
    - Foundations for Agentic use:
        ...
        - MCP servers
        - Demo of an AI agent
- All visualisations must be eye catching and rendered in 3D for concepts where this makese sense. Ultimately they must help teach the user, so they should be interactive in order to engage the user.
- Interactive elements should result in real choices which make a difference to the end state of the visualisation - e.g. user clicking an element to transition to the next state is NOT a valid form of interactivity.
...
- **The Golden Rule: Make learning about LLMs visual and fun, not intimidating!**
